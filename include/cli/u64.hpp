...
private:
  ...
  static constexpr uint32_t mul32_with_overflow(uint16_t al, uint16_t ah,
                                                uint16_t bl, uint16_t bh,
                                                uint32_t &overflow) {
  ...
  static constexpr uint32_t mul32_with_overflow(uint32_t a, uint32_t b,
                                                uint32_t &overflow) {
...
struct u64 {
  ...
  constexpr u64(std::uint64_t v) : v(v) {}
